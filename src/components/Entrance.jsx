    ...
    >
      ...
      <div className="entrance-content relative flex flex-col items-center">
        ...
        <button
          ...
          className="group relative grid h-[42vmin] w-[42vmin] max-h-80 max-w-80 min-h-56 min-w-56 place-items-center rounded-full glass animate-pulseGlow preserve-3d transition-transform duration-500 hover:scale-[1.04]"
        ...
        >
          ...
          {/* Your Logo */}
          <span className="animate-floaty flex items-center justify-center">
            <img
              src={logo}
              alt="ARCH ASSIST"
              draggable={false}
              className="h-[48%] w-[48%] object-contain rounded-xl select-none drop-shadow-[0_18px_30px_rgba(201,166,107,0.45)]"
              style={{
                minWidth: 96,
                minHeight: 96,
              }}
        ...
        <div className="mt-12 flex flex-col items-center">
          <span className="font-display text-lg tracking-[0.5em] text-ink">
            TAP TO ENTER
          </span>

          <span className="mt-3 h-px w-16 gold-line" />

          <span className="mt-4 text-[11px] tracking-[0.35em] uppercase text-muted">
      ...
      <div
        ref={flash}
        className="pointer-events-none absolute inset-0 z-[95] bg-white opacity-0"
      />
    </div>
  );
}